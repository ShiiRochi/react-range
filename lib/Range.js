...
var Range = /** @class */ (function (_super) {
    ...
    function Range(props) {
        ...
        _this.state = {
            draggedTrackPos: [-1, -1],
            draggedThumbIndex: -1,
            thumbZIndexes: new Array(((_b = (_a = _this.props) === null || _a === void 0 ? void 0 : _a.values) === null || _b === void 0 ? void 0 : _b.length) || 0).fill(0).map(function (t, i) { return i; }),
            isChanged: false,
            markOffsets: []
        };
        ...
        _this.onMouseDownTrack = function (e) {
            ...
            if (e.button !== 0)
                return;
            var _b = _this.props, values = _b.values, draggableTrack = _b.draggableTrack, direction = _b.direction;
            e.persist();
            e.preventDefault();
            ...
            if (values.length > 1 && draggableTrack) {
                ...
                var draggedThumbIndex = utils_1.getClosestThumbIndex(_this.thumbRefs.map(function (t) { return t.current; }), e.clientX, e.clientY, direction);
        ...
        _this.onMove = function (clientX, clientY) {
            ...
            if (draggedTrackPos[0] !== -1 && draggedTrackPos[1] !== -1) {
                ...
                if (draggedThumbIndex === -1) {
                    _this.thumbRefs[0] = React.createRef();
                    onChange(utils_1.replaceAt(values, 0, _this.normalizeValue(newValue, 0)));
                }
        ...
        var min = props.min, max = props.max, step = props.step, values = props.values;
        _this.numOfMarks = (max - min) / step;
        ...
        _this.thumbRefs = Array.isArray(values) ? values.map(function () { return React.createRef(); }) : [];
        for (var i = 0; i < _this.numOfMarks + 1; i++) {
            _this.markRefs[i] = React.createRef();
        }
        if (!utils_1.isStepDivisible(min, max, step)) {
